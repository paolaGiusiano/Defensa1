...
{
    /// <summary>
    /// Clase base para implementar el patrón Chain of Responsibility. Esta clase base implmementa 
    ...
    public abstract class BaseHandler : IHandler
    {
        ...
        protected virtual void InternalHandle(Message message, out string response)
        {
